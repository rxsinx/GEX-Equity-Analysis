...
NIFTY100_EXTRA = [
    "HAVELLS", "VOLTAS", "UNITDSPR", "DABUR", "GODREJCP",
    "PIDILITIND", "ICICIGI", "BANKBARODA", "PNB", "CANBK",
    "FEDERALBNK", "IDFCFIRSTB", "MUTHOOTFIN", "CHOLAFIN", "LTIM",
    "PERSISTENT", "COFORGE", "MPHASIS", "OFSS", "KPIT",
    "DMART", "NYKAA", "PAYTM", "ZOMATO", "POLICYBZR",
    "ADANIGREEN", "ADANIPOWER", "ADANITRANS", "TATAPOWER", "TORNTPOWER",
    "INDIGO", "IRCTC", "GMRINFRA", "IRECL", "PFC",
    "RECLTD", "HPCL", "IOC", "GAIL", "PETRONET",
    "VEDL", "NMDC", "SAIL", "NATIONALUM", "HINDZINC",
    "AMBUJACEM", "360ONE", "SHREECEM", "ABB", "POWERINDIA", "DALMIACBHRT"
]
